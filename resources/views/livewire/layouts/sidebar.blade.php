<!-- Sidebar -->
<aside class="fixed bottom-0 left-0 right-0 z-50 flex justify-around w-full h-12 p-1 text-white bg-gray-100 border-t border-gray-300 dark:border-r-0 dark:border-t-0 dark:bg-gray-900 sm:border-r sm:border-t-0 sm:justify-start sm:flex-col sm:h-full sm:w-12">
    <!-- Chats -->
